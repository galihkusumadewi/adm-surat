...
<section class="content">
    ...
    <div class="card">
        ...
        <form id="formEditDisposisi" action="{{ route('admin.disposisi.update', ['id_disposisi' => $disposisi->id_disposisi]) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col-md-6">
    ...
    <div class="modal-footer">
        <a href="{{ route('admin.disposisi.disposisi') }}" class="btn btn-secondary">Batal</a>
                ...
                success: function (response) {
                    Swal.fire('Sukses!', 'Data berhasil diubah!', 'success').then((result) => {
                        if (result.isConfirmed) {
                            window.location.href = "{{ route('admin.disposisi.disposisi') }}";
                        }
                    });
                },
