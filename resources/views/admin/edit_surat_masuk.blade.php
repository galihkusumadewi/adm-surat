...
<section class="content">
    ...
    <div class="card">
        <div class="card-header">
            <form id="formEditSuratMasuk" action="{{ route('admin.masuk.update', ['id_suratmasuk' => $suratMasuk->id_suratmasuk]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="modal-footer">
                    <a href="{{ route('admin.masuk.surat_masuk') }}" class="btn btn-secondary">Batal</a>
                ...
                success: function (response) {
                    Swal.fire('Sukses!', 'Data berhasil diubah!', 'success').then((result) => {
                        if (result.isConfirmed) {
                            window.location.href = "{{ route('admin.masuk.surat_masuk') }}";
                        }
                    });
                },
