...
<section class="content">
    ...
    <div class="card">
        <div class="card-header">
            <form id="formEditSuratKeluar" action="{{ route('kadin.keluar.update', ['id_suratkeluar' => $suratKeluar->id_suratkeluar]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="modal-footer">
                    <a href="{{ route('kadin.keluar.surat_keluar') }}" class="btn btn-secondary">Batal</a>
                ...
                success: function (response) {
                    Swal.fire('Sukses!', 'Data berhasil diubah!', 'success').then((result) => {
                        if (result.isConfirmed) {
                            window.location.href = "{{ route('kadin.keluar.surat_keluar') }}";
                        }
                    });
                },
