...
<section class="content">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formTambahAdmin" action="{{ route('kabag.data_admin.add') }}" method="POST">
                    @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formEditAdmin" action="{{ route('kabag.data_admin.update', ['id' => ':id']) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
...
$(document).ready(function () {
        $('#previewAdmin').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('kabag.data_admin.data_admin') }}",
            columns: [
                { data: 'id', name: 'id' },
                { data: 'name', name: 'name' },
        ...
        $('#simpanAdmin').on('click', function(e) {
            ...
            $.ajax({
                url: "{{ route('kabag.data_admin.add') }}",
    ...
    $('#editAdminModal').on('show.bs.modal', function (event) {
        ...
        modal.find('form').attr('action', "{{ route('kabag.data_admin.update', ['id' => ':id']) }}".replace(':id', id));
    ...
    $('#formEditAdmin').on('submit', function (e) {
        ...
        $.ajax({
            url: "{{ route('kabag.data_admin.update', ['id' => ':id']) }}".replace(':id', id),
            method: "PUT",
            data: data,
            headers: {
